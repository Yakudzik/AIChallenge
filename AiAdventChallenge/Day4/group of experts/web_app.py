...
from web_logic import TEMPERATURE_KEY, process_text
  ...
  <body>
          ...
          <div class="action-group provider">
            <div class="provider-item">
              ...
              <div class="provider-slider">
                <label for="temperatureDeepseek">Temperature: <span id="temperatureValueDeepseek">0.5</span></label>
                <input id="temperatureDeepseek" type="range" min="0" max="1" step="0.1" value="0.5" />
              </div>
            </div>
            <div class="provider-item">
              <button id="providerYandex" class="secondary" type="button">Yandex Cloud</button>
              <div class="provider-slider">
                <label for="temperatureYandex">Temperature: <span id="temperatureValueYandex">0.5</span></label>
            ...
            <div class="provider-item">
              ...
              <div class="provider-slider">
                <label for="temperatureClaude">Temperature: <span id="temperatureValueClaude">0.5</span></label>
                <input id="temperatureClaude" type="range" min="0" max="1" step="0.1" value="0.5" />
              </div>
            </div>
          </div>
          <div class="action-group">
            <button id="clear" class="secondary" type="button">Очистить чат</button>
          </div>
        </div>
      </aside>
    ...
    <div id="systemPromptModal" class="modal" role="dialog" aria-modal="true">
      <div class="modal-card">
        ...
        <div class="modal-actions">
          <button id="systemPromptSave" type="button">Сохранить промпт</button>
        </div>
      </div>
    </div>
    ...
    <script>
      ...
      function saveSystemPrompt() {
        ...
        requestCommand("/set_system_prompt" + text)
          ...
          .catch(function (error) {
            addMessage("Ошибка сохранения промпта: " + error, "bot");
          });
      }
      ...
      systemPromptBtn.addEventListener("click", function () {
        requestCommand("/system_prompt").then(openSystemPromptModal);
      });
      ...
      function getTemperatures() {
        return {
          deepseek: parseFloat(temperatureDeepseek ? temperatureDeepseek.value : "0.6"),
          yandex: parseFloat(temperatureYandex ? temperatureYandex.value : "0.6"),
          claude: parseFloat(temperatureClaude ? temperatureClaude.value : "0.6"),
        };
      }
...
def message(payload: MessageIn):
    ...
    if payload.temperatures:
        user_data[TEMPERATURE_KEY] = payload.temperatures
